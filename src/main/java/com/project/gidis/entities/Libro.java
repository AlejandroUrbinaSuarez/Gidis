...
public class Libro {
    ...
    public Libro(Long id, String isbn, String titulo, String lugarPublicacion, String editorial, String disciplina, String certificadoCreditos, String certificadoInstitucionAvala, Set<Usuario> usuario) {
        this.id = id;
        this.isbn = isbn;
        this.titulo = titulo;
