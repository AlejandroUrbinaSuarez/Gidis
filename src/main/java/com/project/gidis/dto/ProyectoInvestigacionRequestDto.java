...
public class ProyectoInvestigacionRequestDto {
    ...
    public ProyectoInvestigacionRequestDto() {
    }

    public ProyectoInvestigacionRequestDto(String titulo, String tipoProyecto, String mesInicio, String mesFin, String anioInicio, String anioFin, boolean financiado, String fuenteFinanciacion, String ambito, String resumen, String instituciones) {
        this.titulo = titulo;
